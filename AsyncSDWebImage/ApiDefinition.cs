...
namespace AsyncSDWebImage
{
	...
	interface NSData_ImageContentType
	{
		...
		SDImageFormat Sd_imageFormatForImageData([NullAllowed] NSData data);
	}
	...
	interface UIView_WebCache
	{
		...
		void Sd_SetImageWithURL([NullAllowed] NSUrl url, [NullAllowed] UIImage placeholder, SDWebImageOptions options, [NullAllowed] string operationKey, [NullAllowed] SDSetImageBlock setImageBlock, [NullAllowed] SDWebImageDownloaderProgressBlock progressBlock, [NullAllowed] SDExternalCompletionBlock completedBlock);
		...
		bool Sd_showActivityIndicatorView { get; }
